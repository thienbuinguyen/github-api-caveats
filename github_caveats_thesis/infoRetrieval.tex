...
This chapter describes the process used for extracting caveats from the Java 12 API documentation, extracting GitHub community text, and linking the two via NLP techniques and construction of information retrieval systems. However, this approach is found to unsuccessful when applied to GitHub data, and is therefore documented as a reference and bridge for the alternative approach used in Chapter \ref{cha:codeAnalysis}. \\

\noindent
Section \ref{sec:info-intro} provides an overview of linking API caveats to code examples on Q\&A websites and the same approach applied to GitHub for this thesis. \\

\noindent
Section \ref{sec:info-design} describes the use of TF-IDF, word2vec and BM25 as information retrieval systems.\\

Section \ref{sec:info-implement} discuses the implementation of the approach, which consists of the 
the extraction of GitHub data and API caveats from the Java 12 API documentation. The complete process used for sentence matching of GitHub comment sentences and the Java 12 API caveat sentences is also included. \\

\noindent
Section \ref{sec:info-results} describes the results of sentence matching. \\
